                    ...
                    if (userRole === "Admin")
                        if (key === 'carTwoDate' || key === 'carTwoTime' || key === 'secondWeight') {
                            ...
                            cell.addEventListener('blur', function () {
                                ...
                                fetch(`http://localhost:8080/tickets/${rowData.ticketId}/2`,{
                                    method: 'PUT',
                                    headers: {
...
function updateInputGraph_s2(isVillage) {
    ...
    const url1 = `http://localhost:8080/tickets/itemName-site/weight-date-list?itemName=مخلفات  تصلح للمعالجة&siteNo=2&startDate=${startDatex}&endDate=${endDatex}&centerId=${selectedCenter}&villageId=${selectedVillage}`; //مخلفات تصلح للمعالجة
    const url2 = `http://localhost:8080/tickets/itemName-site/weight-date-list?itemName=مخلفات لا تصلح للمعالجة&siteNo=2&startDate=${startDatex}&endDate=${endDatex}&centerId=${selectedCenter}&villageId=${selectedVillage}`; //مخلفات لا تصلح للمعالجة
...
function updateOutputGraph_s2(isVillage) {
    ...
    const url1 = `http://localhost:8080/tickets/itemName-site/weight-date-list?itemName=وقود بديل&siteNo=2&startDate=${startDatex}&endDate=${endDatex}&centerId=${selectedCenter}&villageId=${selectedVillage}`; // وقود بديل
    const url2 = `http://localhost:8080/tickets/itemName-site/weight-date-list?itemName=اسمدة عضوية&siteNo=2&startDate=${startDatex}&endDate=${endDatex}&centerId=${selectedCenter}&villageId=${selectedVillage}`; // اسمدة عضوية
    const url3 = `http://localhost:8080/tickets/itemName-site/weight-date-list?itemName=مرفوضات&siteNo=2&startDate=${startDatex}&endDate=${endDatex}&centerId=${selectedCenter}&villageId=${selectedVillage}`; //مرفوضات
    const url4 = `http://localhost:8080/tickets/itemName-site/weight-date-list?itemName=مفروزات&siteNo=2&startDate=${startDatex}&endDate=${endDatex}&centerId=${selectedCenter}&villageId=${selectedVillage}`; //مفروزات
...
function updateIPChartData(startDate, endDate) {
    const urlIP1 = `http://localhost:8080/tickets/itemName/weight?itemName=مخلفات  تصلح للمعالجة&siteNo=2&startDate=${startDate}&endDate=${endDate}`; // مخلفات تصلح للمعالجة
    const urlIP2 = `http://localhost:8080/tickets/itemName/weight?itemName=مخلفات لا تصلح للمعالجة&siteNo=2&startDate=${startDate}&endDate=${endDate}`; // مخلفات لا تصلح للمعالجة
    Promise.all([
...
function updateOPChartData(startDate, endDate) {
    const urlOP1 = `http://localhost:8080/tickets/itemName/weight?itemName=اسمدة عضوية&siteNo=2&startDate=${startDate}&endDate=${endDate}`; // اسمدة عضوية
    const urlOP2 = `http://localhost:8080/tickets/itemName/weight?itemName=وقود بديل&siteNo=2&startDate=${startDate}&endDate=${endDate}`; // وقود بديل
    const urlOP3 = `http://localhost:8080/tickets/itemName/weight?itemName=مرفوضات&siteNo=2&startDate=${startDate}&endDate=${endDate}`; // مرفوضات
    const urlOP4 = `http://localhost:8080/tickets/itemName/weight?itemName=مفروزات&siteNo=2&startDate=${startDate}&endDate=${endDate}`; // مفروزات
...
function updateRejBox(startDate, endDate) {
    const urlAcc = `http://localhost:8080/tickets/itemName/weight?itemName=مخلفات  تصلح للمعالجة&siteNo=2&startDate=${startDate}&endDate=${endDate}`; // مخلفات تصلح للمعالجة
    const urlRej = `http://localhost:8080/tickets/itemName/weight?itemName=مرفوضات&siteNo=2&startDate=${startDate}&endDate=${endDate}`; // مرفوضات
...
function updateAccBox(startDate, endDate) {
    const accUrl = `http://localhost:8080/tickets/itemName/weight?itemName=مخلفات  تصلح للمعالجة&siteNo=2&startDate=${startDate}&endDate=${endDate}`; // مخلفات تصلح للمعالجة
    const totInUrl = `http://localhost:8080/tickets/itemType/weight?itemType=مدخلات&siteNo=2&startDate=${startDate}&endDate=${endDate}`;
...
function updateOPBox(startDate, endDate) {
    const url = `http://localhost:8080/tickets/itemType/weight?itemType=مخرجات&siteNo=2&startDate=${startDate}&endDate=${endDate}`;
...
function updateIPBox(startDate, endDate) {
    const url = `http://localhost:8080/tickets/itemType/weight?itemType=مدخلات&siteNo=2&startDate=${startDate}&endDate=${endDate}`;
...
function updateMassBox(startDate, endDate) {
    const totInURL = `http://localhost:8080/tickets/itemType/weight?itemType=مدخلات&siteNo=2&startDate=${startDate}&endDate=${endDate}`;
    const totOutURL = `http://localhost:8080/tickets/itemType/weight?itemType=مخرجات&siteNo=2&startDate=${startDate}&endDate=${endDate}`;
    const accURL = `http://localhost:8080/tickets/itemName/weight?itemName=مخلفات  تصلح للمعالجة&siteNo=2&startDate=${startDate}&endDate=${endDate}`; // مخلفات تصلح للمعالجة
    const rejURL = `http://localhost:8080/tickets/itemName/weight?itemName=مخلفات لا تصلح للمعالجة&siteNo=2&startDate=${startDate}&endDate=${endDate}`; // مخلفات لا تصلح للمعالجة
