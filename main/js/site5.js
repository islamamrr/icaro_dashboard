...
function updateInputGraph_s5(isVillage) {
    ...
    const url1 = `http://isdom.online/dash_board/tickets/itemName-site/weight-date-list?itemName=مخلفات  تصلح للمعالجة&siteNo=5&startDate=${startDatex}&endDate=${endDatex}&centerId=${selectedCenter}&villageId=${selectedVillage}`; //مخلفات تصلح للمعالجة
    const url2 = `http://isdom.online/dash_board/tickets/itemName-site/weight-date-list?itemName=مخلفات لا تصلح للمعالجة&siteNo=5&startDate=${startDatex}&endDate=${endDatex}&centerId=${selectedCenter}&villageId=${selectedVillage}`; //مخلفات لا تصلح للمعالجة
...
function updateOutputGraph_s5() {
    ...
    const waqoodURL = `http://isdom.online/dash_board/tickets/itemName-site/weight-date-list?itemName=وقود بديل&siteNo=5&startDate=${startDatex}&endDate=${endDatex}`; // وقود بديل
    const asmedaURL = `http://isdom.online/dash_board/tickets/itemName-site/weight-date-list?itemName=اسمدة عضوية&siteNo=5&startDate=${startDatex}&endDate=${endDatex}`; // اسمدة عضوية
    ...
    const mafroozatURL = `http://isdom.online/dash_board/tickets/itemName-site/weight-date-list?itemName=مفروزات&siteNo=5&startDate=${startDatex}&endDate=${endDatex}`; //مفروزات
    Promise.all([
