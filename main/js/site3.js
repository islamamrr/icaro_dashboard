...
function updateDatatable(startDate, endDate) {
    ...
    fetch(`https://ecaru.xyz/dash_board/tickets/all?siteNo=3&startDate=${startDate}&endDate=${endDate}`)
                    ...
                    if (userRole === "Admin")
                        if (key === 'carTwoDate' || key === 'carTwoTime' || key === 'secondWeight') {
                            ...
                            cell.addEventListener('keyup', function () {
                                ...
                                fetch(`https://ecaru.xyz/dash_board/tickets/${rowData.ticketId}/3`, {
                                    method: 'PUT',
                                    headers: {
...
function updateInputGraph_s3() {
    ...
    const totalURL = `https://ecaru.xyz/dash_board/tickets/itemName-site/weight-date-list?siteNo=3&startDate=${startDatex}&endDate=${endDatex}`;
    const URL1 = `https://ecaru.xyz/dash_board/tickets/itemName-site/weight-date-list?siteNo=3&clientType=${clients[0]}&startDate=${startDatex}&endDate=${endDatex}`;
    const URL2 = `https://ecaru.xyz/dash_board/tickets/itemName-site/weight-date-list?siteNo=3&clientType=${clients[1]}&startDate=${startDatex}&endDate=${endDatex}`;
    const URL4 = `https://ecaru.xyz/dash_board/tickets/itemName-site/weight-date-list?siteNo=3&clientType=${clients[3]}&startDate=${startDatex}&endDate=${endDatex}`;
    const URL5 = `https://ecaru.xyz/dash_board/tickets/itemName-site/weight-date-list?siteNo=3&clientType=${clients[4]}&startDate=${startDatex}&endDate=${endDatex}`;
    const URL6 = `https://ecaru.xyz/dash_board/tickets/itemName-site/weight-date-list?siteNo=3&clientType=${clients[5]}&startDate=${startDatex}&endDate=${endDatex}`;
    const othersURL = `https://ecaru.xyz/dash_board/tickets/itemName-site/weight-date-list?siteNo=3&clientType=${otherClient}&startDate=${startDatex}&endDate=${endDatex}`;
...
function updateIPChartData(startDate, endDate) {
    // const urlIP1 = `https://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=مخلفات  تصلح للمعالجة&siteNo=3&startDate=${startDate}&endDate=${endDate}`; // مخلفات تصلح للمعالجة
    // const urlIP2 = `https://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=مخلفات لا تصلح للمعالجة&siteNo=3&startDate=${startDate}&endDate=${endDate}`; // مخلفات لا تصلح للمعالجة

    const URL1 = `https://ecaru.xyz/dash_board/tickets/itemName/weight?siteNo=3&clientType=${clients[0]}&startDate=${startDate}&endDate=${endDate}`;
    const URL2 = `https://ecaru.xyz/dash_board/tickets/itemName/weight?siteNo=3&clientType=${clients[1]}&startDate=${startDate}&endDate=${endDate}`;
    const URL4 = `https://ecaru.xyz/dash_board/tickets/itemName/weight?siteNo=3&clientType=${clients[3]}&startDate=${startDate}&endDate=${endDate}`;
    const URL5 = `https://ecaru.xyz/dash_board/tickets/itemName/weight?siteNo=3&clientType=${clients[4]}&startDate=${startDate}&endDate=${endDate}`;
    const URL6 = `https://ecaru.xyz/dash_board/tickets/itemName/weight?siteNo=3&clientType=${clients[5]}&startDate=${startDate}&endDate=${endDate}`;
    const othersURL = `https://ecaru.xyz/dash_board/tickets/itemName/weight?siteNo=3&clientType=${otherClient}&startDate=${startDate}&endDate=${endDate}`;
...
function updateIPBox(startDate, endDate) {
    const url = `https://ecaru.xyz/dash_board/tickets/itemType/weight?itemType=مدخلات&siteNo=3&startDate=${startDate}&endDate=${endDate}`;
