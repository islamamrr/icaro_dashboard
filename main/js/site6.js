...
function updateDatatable(startDate, endDate) {
    ...
    fetch(`http://ecaru.xyz/dash_board/tickets/all?siteNo=6&startDate=${startDate}&endDate=${endDate}`)
                    ...
                    if (userRole === "Admin")
                        if (key === 'carTwoDate' || key === 'carTwoTime' || key === 'secondWeight') {
                            ...
                            cell.addEventListener('keyup', function () {
                                ...
                                fetch(`http://ecaru.xyz/dash_board/tickets/${rowData.ticketId}/6`, {
                                    method: 'PUT',
                                    headers: {
...
function updateInputGraph_s6(isVillage) {
    ...
    const url1 = `http://ecaru.xyz/dash_board/tickets/itemName-site/weight-date-list?itemName=مخلفات  تصلح للمعالجة&siteNo=6&startDate=${startDateIPGraph}&endDate=${endDateIPGraph}&centerId=${selectedCenter}&villageId=${selectedVillage}`; //مخلفات تصلح للمعالجة
    const url2 = `http://ecaru.xyz/dash_board/tickets/itemName-site/weight-date-list?itemName=مخلفات لا تصلح للمعالجة&siteNo=6&startDate=${startDateIPGraph}&endDate=${endDateIPGraph}&centerId=${selectedCenter}&villageId=${selectedVillage}`; //مخلفات لا تصلح للمعالجة
...
function updateOutputGraph_s6() {
    const waqoodURL = `http://ecaru.xyz/dash_board/tickets/itemName-site/weight-date-list?itemName=وقود بديل&siteNo=6&startDate=${startDateOPGraph}&endDate=${endDateOPGraph}`; // وقود بديل
    const asmedaURL = `http://ecaru.xyz/dash_board/tickets/itemName-site/weight-date-list?itemName=اسمدة عضوية&siteNo=6&startDate=${startDateOPGraph}&endDate=${endDateOPGraph}`; // اسمدة عضوية
    ...
    const mafroozatURL = `http://ecaru.xyz/dash_board/tickets/itemName-site/weight-date-list?itemName=مفروزات&siteNo=6&startDate=${startDateOPGraph}&endDate=${endDateOPGraph}`; //مفروزات
    Promise.all([
...
function updateIPChartData(startDate, endDate) {
    const urlIP1 = `http://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=مخلفات  تصلح للمعالجة&siteNo=6&startDate=${startDate}&endDate=${endDate}`; // مخلفات تصلح للمعالجة
    const urlIP2 = `http://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=مخلفات لا تصلح للمعالجة&siteNo=6&startDate=${startDate}&endDate=${endDate}`; // مخلفات لا تصلح للمعالجة
    Promise.all([
...
function updateOPChartData(startDate, endDate) {
    const urlOP1 = `http://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=اسمدة عضوية&siteNo=6&startDate=${startDate}&endDate=${endDate}`; // اسمدة عضوية
    const urlOP2 = `http://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=وقود بديل&siteNo=6&startDate=${startDate}&endDate=${endDate}`; // وقود بديل
    ...
    const urlOP4 = `http://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=مفروزات&siteNo=6&startDate=${startDate}&endDate=${endDate}`; // مفروزات
...
function updateIPBox(startDate, endDate) {
    const url = `http://ecaru.xyz/dash_board/tickets/itemType/weight?itemType=مدخلات&siteNo=6&startDate=${startDate}&endDate=${endDate}`;
...
function updateAccIPBox(startDate, endDate) {
    const url = `http://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=مخلفات  تصلح للمعالجة&siteNo=6&startDate=${startDate}&endDate=${endDate}`; // مخلفات تصلح للمعالجة
    fetch(url)
        .then(response => response.json()).catch(() => 0)
        .then(data => {
            const newValue = data;
...
function updateRejIPBox(startDate, endDate) {
    const url = `http://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=مخلفات لا تصلح للمعالجة&siteNo=6&startDate=${startDate}&endDate=${endDate}`; // مخلفات تصلح للمعالجة
    fetch(url)
        .then(response => response.json()).catch(() => 0)
        .then(data => {
            const newValue = data;
...
function updateRejRateBox(startDate, endDate) {
    const accUrl = `http://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=مخلفات  تصلح للمعالجة&siteNo=6&startDate=${startDate}&endDate=${endDate}`; // مخلفات تصلح للمعالجة
    const rejUrl = `http://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=مخلفات لا تصلح للمعالجة&siteNo=6&startDate=${startDate}&endDate=${endDate}`;
...
function updateAccRateBox(startDate, endDate) {
    const accUrl = `http://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=مخلفات  تصلح للمعالجة&siteNo=6&startDate=${startDate}&endDate=${endDate}`; // مخلفات تصلح للمعالجة
    const totInUrl = `http://ecaru.xyz/dash_board/tickets/itemType/weight?itemType=مدخلات&siteNo=6&startDate=${startDate}&endDate=${endDate}`;
...
function updateInOperationBox() {
    ...
    const percentagesURL = 'http://ecaru.xyz/dash_board/accumulated/percentage?siteNo=6';
    const accumulatedWeightsURL = 'http://ecaru.xyz/dash_board/accumulated/weight?siteNo=6'
    const acceptedInputURL = `http://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=مخلفات  تصلح للمعالجة&siteNo=6&startDate=${startDate}&endDate=${endDate}`; // مخلفات تصلح للمعالجة
    const asmedaURL = `http://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=اسمدة عضوية&siteNo=6&startDate=${startDate}&endDate=${endDate}`; // اسمدة عضوية
    const waqoodURL = `http://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=وقود بديل&siteNo=6&startDate=${startDate}&endDate=${endDate}`; // وقود بديل
    const marfoodatURL = `http://ecaru.xyz/dash_board/tickets/itemName/weight?siteNo=3&clientType=${currentClientType}&startDate=${startDate}&endDate=${endDate}`; // مرفوضات
    const mafroozatURL = `http://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=مفروزات&siteNo=6&startDate=${startDate}&endDate=${endDate}`; // مفروزات
...
function updateOPBox(startDate, endDate) {
    const url = `http://ecaru.xyz/dash_board/tickets/output/weight?itemType=مخرجات&siteNo=6&clientType=${currentClientType}&startDate=${startDate}&endDate=${endDate}`;
...
function updateAsmedaOPBox(startDate, endDate) {
    const url = `http://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=اسمدة عضوية&siteNo=6&startDate=${startDate}&endDate=${endDate}`; // مخلفات تصلح للمعالجة
    fetch(url)
        .then(response => response.json()).catch(() => 0)
        .then(data => {
            const newValue = data;
...
function updateWaqoodOPBox(startDate, endDate) {
    const url = `http://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=وقود بديل&siteNo=6&startDate=${startDate}&endDate=${endDate}`; // مخلفات تصلح للمعالجة
    fetch(url)
        .then(response => response.json()).catch(() => 0)
        .then(data => {
            const newValue = data;
...
function updateMafroozatOPBox(startDate, endDate) {
    const url = `http://ecaru.xyz/dash_board/tickets/itemName/weight?itemName=مفروزات&siteNo=6&startDate=${startDate}&endDate=${endDate}`; // مخلفات تصلح للمعالجة
    fetch(url)
        .then(response => response.json()).catch(() => 0)
        .then(data => {
            const newValue = data;
...
document.getElementById('openOperationPopupBtn').addEventListener('click', function () {
    ...
    form.addEventListener('submit', function (e) {
        ...
        const urlPercentage = 'http://ecaru.xyz/dash_board/accumulated/update-percentage/6'
        const urlAccuWeight = 'http://ecaru.xyz/dash_board/accumulated/update-weight/6'
